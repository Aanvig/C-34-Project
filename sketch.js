...
var superman, string, backgroundImage, monster;
...
box2=new Box(1000,170,70,70)
box3=new Box(1000,240,70,70)
box4 = new Box(1000,310,70,70)
box5=new Box(1000,380,70,70)
box6 =new Box(1000,450,70,70)
box7 = new Box(900,170,70,70)
 box8 = new Box(900,240,70,70)
 box9 = new Box(900,310,70,70)
 box10= new Box(900,380,70,70)
 box11 = new Box(900,450,70,70)
 box12= new Box(900,520,70,70)
 box13= new Box(800,170,70,70)
 box14= new Box(800,240,70,70)
 box15= new Box(800,310,70,70)
 box16= new Box(800,380,70,70)
 box17= new Box(800,450,70,70)
 box18= new Box(800,520,70,70)
 box19= new Box(900,100,70,70)
 box20= new Box(700,100,70,70)
 box21= new Box(700,170,70,70)
 box22= new Box(700,240,70,70)
 box23= new Box(700,310,70,70)
 box24= new Box(700,380,70,70)
...
function draw(){
    ...
    fill("orange")
    textSize(30)
    text("Drag The Mouse To Move Larry",10,30)
